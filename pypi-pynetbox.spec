...
Source0  : https://files.pythonhosted.org/packages/64/77/147ba1a06fd5c064ddab411bfd0d8ee86856e5723b82f7a4931e96838e4a/pynetbox-7.4.0.tar.gz
...
%prep
%setup -q -n pynetbox-7.4.0
cd %{_builddir}/pynetbox-7.4.0
pushd ..
cp -a pynetbox-7.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723126324
