...
Source0  : https://files.pythonhosted.org/packages/0f/e2/4d2815362f800bc89d942bc430dccd8ee81a046216573eedbd8f619486f4/pynetbox-7.3.3.tar.gz
...
%prep
%setup -q -n pynetbox-7.3.3
cd %{_builddir}/pynetbox-7.3.3
pushd ..
cp -a pynetbox-7.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704728951
