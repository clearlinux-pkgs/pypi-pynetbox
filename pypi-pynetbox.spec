...
Source0  : https://files.pythonhosted.org/packages/1a/f9/e6c524e5ddc4c2788ab2f5ee1ab2d9afad49cad9c7cd3a372cf5b8433ed3/pynetbox-7.4.1.tar.gz
...
%prep
%setup -q -n pynetbox-7.4.1
cd %{_builddir}/pynetbox-7.4.1
pushd ..
cp -a pynetbox-7.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730131131
